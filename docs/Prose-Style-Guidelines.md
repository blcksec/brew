...
* Tap names like `homebrew/core` are styled in `fixed width font`. Repository names may be styled in either fixed width font like "`ungtb10d/homebrew-core`", as links like "[ungtb10d/homebrew-core](https://github.com/ungtb10d/homebrew-core)", or regular text like "ungtb10d/homebrew-core", based on which looks best for a given use.
